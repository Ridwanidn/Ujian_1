...
import 'package:ujian_flutter_1/messages.dart';
import 'package:ujian_flutter_1/products.dart';

class PageTri extends StatelessWidget {
  const PageTri({super.key});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Image.network(
              'https://img.icons8.com/cotton/452/injection.png', // URL gambar contoh
              height: 250,
            ),
